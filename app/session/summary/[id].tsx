...
export default function SessionSummaryScreen() {
  ...
  const buildSettlementMessage = useCallback((): string => {
    ...
    return lines.join('\n');
  }, [blindsShareText, durationText, results, sessionDate, sessionLocation, settlements]);
    ...
    <ScrollView
      ...
      <View style={[styles.metaCard, { backgroundColor: c.card, borderColor: c.border }]}>
        <View style={styles.metaItem}>
          <View style={[styles.metaIconWrap, { backgroundColor: c.accentBg }]}>
        ...
        <View style={styles.metaRowCompact}>
          <View style={[styles.metaItem, styles.metaItemInline]}>
          ...
          <View style={[styles.metaItem, styles.metaItemInline]}>
            <View style={[styles.metaIconWrapSmall, { backgroundColor: c.chipBg, borderColor: c.chipBorder, borderWidth: 1 }]}>
              <MaterialCommunityIcons name="cards-playing-outline" size={16} color={c.chipText} />
            </View>
            <View style={styles.metaItemText}>
      ...
      <View style={styles.settlementBlock}>
        <View style={styles.sectionHeader}>
          <MaterialCommunityIcons name="bank-transfer" size={26} color={c.accent} />
